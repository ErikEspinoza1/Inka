...
class _AuthScreenState extends State<AuthScreen> {
  ...
  final TextEditingController _nameCtrl = TextEditingController(); // Solo para registro
  ...
  void _goToHome() {
    // Navegar al Home y borrar el historial para que no puedan volver atrás
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (_) => const HomeScreen()), // Tu pantalla principal actual
    );
  }
