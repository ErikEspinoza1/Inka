  ...
  Widget build(BuildContext context) {
    ...
    if (_artistData == null) {
      return const Scaffold(
        ...
        body: Center(child: Text('Error al cargar el perfil', style: TextStyle(color: Colors.white))),
      );
    }
          ...
          children: [
            ...
            if (_portfolioImages.isNotEmpty) ...[
              const Text('Portfolio',
                  style: TextStyle(color: Colors.tealAccent, fontSize: 20, fontWeight: FontWeight.bold)),
              const SizedBox(height: 10),
              _buildPortfolioSlider(),
            ] else
              const Text('Este artista aún no tiene fotos en su portfolio',
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(_artistData!['shop_name'] ?? 'Sin nombre',
                        style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                    Text(_artistData!['styles']?.join(' • ') ?? 'Sin especialidad',
          ...
          if (_artistData!['bio'] != null && _artistData!['bio'].isNotEmpty) ...[
            ...
            Text(_artistData!['bio'], style: const TextStyle(color: Colors.white, fontSize: 14)),
            const SizedBox(height: 16),
          ],
          _buildContactInfo(),
        ],
